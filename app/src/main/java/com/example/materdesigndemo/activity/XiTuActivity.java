...
import com.example.materdesigndemo.adapter.ViewPagerAdapter;
...
public class XiTuActivity extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                if (verticalOffset <= -head_layout.getHeight() / 2){
                    mCollapsingToolbarLayout.setTitle("在路上的罗小贱");
                }else {
        ...
        //跟PaletteViewPagerAdapter一模一样，可以直接用这个代替
//        PaletteViewPagerAdapter paAdapter = new PaletteViewPagerAdapter(getSupportFragmentManager(),this);
        ...
        //设置头像
        Glide.with(this).load(R.mipmap.bg).bitmapTransform(new RoundedCornersTransformation(
                this,90,0)).into(head_iv);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.webview:
//                msg += "博客跳转";
                Uri uri = Uri.parse("http://www.luojunquan.top");
